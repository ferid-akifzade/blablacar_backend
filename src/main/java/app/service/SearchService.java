...
public class SearchService {
    ...
    private List<HashMap<String, Object>> getComprehensiveData(List<Ride> collect) {
    ...
    public List<HashMap<String, Object>> findAll(String departure, String destination, String datetime) {
        ...
        return getComprehensiveData(collect);
    }

    public List<HashMap<String, Object>> getAll() {
        return getComprehensiveData((List<Ride>) rideRepository.findAll());
    }
}